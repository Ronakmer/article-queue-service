...
class GetSingleAiResponse:
    ...
    #                     # Always return the wrapped object
    #                     data_obj = {
    #                         "message": response_data
    #                     }
    ...
    #                     return data_obj  # Whether final pending or valid

    #                 else:
    #                     print(f"Attempt {attempt}: Unexpected status code {response.status_code}")
    #                     return {"message": {"error": f"Status code {response.status_code}"}}  # wrapped for store method
